...
table {width:45vw; height:45vh;border: 1px solid black; margin-right: 10%; margin-left: 10%;margin-top: 5%;margin-bottom: 5%;}
th, td{border: 1px solid black; font-family: Segoe UI; text-align: center; font-size: 1.3vw;}
...
<div class="row">
  <div class="column left">
      <div class="image">
       <img src="Self.png" alt="Myself" width=55%; height=55%; style="margin-left: 10%;">
      </div>
  ...
  <div class="column right"><div class="education">
    <div class="ed-heading grey">
      <i class="fas fa-school icon"></i>
      <h2 style="font-size: 2.5vw; margin-left: 5%; font-style: oblique; color: brown;">Education</h2>
    </div>
    ...
    <table>
      ...
      <tr>
        ...
        <td>87%</td>
        <td><button onclick="document.location='https://www.andhrauniversity.edu.in/'">Andhra University</button></td>
      </tr>
      <tr>
        <td>Intermediate</td>
        <td>Sri Chaitanya College</td>
        <td>95%</td>
        <td><button onclick="document.location='https://srichaitanya.net/'">Chaitanya College</button></td>
      </tr>
      <tr>
        <td>SSC</td>
        <td>Sri Lakshmi HIgh School</td>
        <td>92%</td>
        <td><button onclick="document.location='http://srilakshmischools.com/'">Sri Lakshmi School</button></td>
      </tr>
    </table><br><br><br>
  </div> 
        </div> 
